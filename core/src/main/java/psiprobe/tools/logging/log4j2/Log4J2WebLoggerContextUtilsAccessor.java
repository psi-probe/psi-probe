...
public class Log4J2WebLoggerContextUtilsAccessor extends DefaultAccessor {
    ...
    /** The Constant logger. */
    protected static final Logger logger = LoggerFactory.getLogger(Log4J2WebLoggerContextUtilsAccessor.class);
   ...
   * @throws ClassNotFoundException the class not found exception
    ...
    public Log4J2LoggerContextAccessor getWebLoggerContext(ServletContext ctx) {
        ...
        try {
            ...
            try {
                getWebLoggerContext = MethodUtils.getAccessibleMethod(clazz, "getWebLoggerContext", new Class[] { ServletContext.class });
            } catch (Exception e) {
