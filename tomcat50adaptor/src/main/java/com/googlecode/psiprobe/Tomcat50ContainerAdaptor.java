...
public class Tomcat50ContainerAdaptor extends AbstractTomcatContainer {
     ...
     * @param dm          the dispatcher mapping for the given FilterMap.  This will be the
     *                    same for each FilterMapping.
     * @param filterClass the class name of the mapped filter.  This will be the same for
     *                    each FilterMapping.
