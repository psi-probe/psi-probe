...
*	**Ensure an [issue](//github.com/psi-probe/psi-probe/issues) exists** before you begin work. If not, file one.
	*	Your change should provide obvious material benefit to the project's developers and/or users. If in doubt, an issue serves as place to discuss your suggestion before you begin work.
