...
public class FlexyPoolDatasourceAccessor implements DatasourceAccessor {
  ...
  private static final List<DatasourceAccessor> DELEGATE_ACCESSORS = DELEGATE_ACCESSOR_CLASS_NAMES
      .stream().map(FlexyPoolDatasourceAccessor::newAccessor).collect(Collectors.toList());
