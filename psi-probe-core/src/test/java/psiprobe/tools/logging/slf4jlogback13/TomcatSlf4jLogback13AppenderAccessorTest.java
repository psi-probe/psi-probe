...
class TomcatSlf4jLogback13AppenderAccessorTest {
  ...
  private TomcatSlf4jLogback13AppenderAccessor accessor;
  private TomcatSlf4jLogback13LoggerAccessor loggerAccessor;

  @BeforeEach
  void setUp() {
    accessor = new TomcatSlf4jLogback13AppenderAccessor();
    loggerAccessor = mock(TomcatSlf4jLogback13LoggerAccessor.class);
  ...
  @Test
  void testGetLogType() {
    assertEquals("tomcatSlf4jLogback13", accessor.getLogType());
  }
