 ...
 */
class LogbackAppenderAccessorTest {

  private LogbackAppenderAccessor accessor;
  private LogbackLoggerAccessor loggerAccessor;

  @BeforeEach
  void setUp() {
    accessor = new LogbackAppenderAccessor();
    loggerAccessor = mock(LogbackLoggerAccessor.class);
  ...
  @Test
  void testGetLogType() {
    assertEquals("logback", accessor.getLogType());
  }
